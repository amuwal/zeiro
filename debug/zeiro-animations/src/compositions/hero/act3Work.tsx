...
export const Act3Work: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      ...
      {/* Arrow */}
      <Arrow x={680} y={460} t={interpolate(frame, [20, 50], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: Easing.bezier(...ease.brand) })} />
...
const Arrow: React.FC<{ x: number; y: number; t: number }> = ({ x, y, t }) => (
  <svg style={{ position: "absolute", left: x, top: y }} width={140} height={20}>
    ...
    {t > 0.85 && (
      <polygon
        points={`${140 - 10},2 140,10 ${140 - 10},18`}
        fill={palette.muted}
      />
    )}
  </svg>
