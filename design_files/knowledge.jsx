    ...
    <div className="kb-pane anim-stagger">
      ...
      <div className="kb-stats">
        ...
        <div className="kb-stat">
          ...
          <span className="num" style={{ color: 'oklch(38% 0.06 150)' }}>
            {fresh}
          </span>
        ...
        <div className="kb-stat">
          ...
          <span className="num" style={{ color: 'oklch(45% 0.10 70)' }}>
            {review}
          </span>
        ...
        <div className="kb-stat">
          ...
          <span className="num" style={{ color: 'var(--urgent)' }}>
            {outdated}
          </span>
          ...
          return (
            <div className="kb-row" key={id}>
              <div>
                ...
                <div className="doc-sub" style={{ fontFamily: 'var(--font-mono)' }}>
                  {id} · {k.section}
                </div>
              </div>
              ...
              <span>
                <span className={`kb-flag ${b.cls}`}>{b.label}</span>
              </span>
            </div>
          );
        })}
