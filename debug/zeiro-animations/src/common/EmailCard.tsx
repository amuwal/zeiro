...
const KIND_STYLES: Record<EmailKind, { dot: string; chip: string; chipBg: string; label: string }> =
  {
    ...
    docs: {
      dot: palette.catDocs,
      chip: palette.catDocs,
      chipBg: palette.catDocsSoft,
      label: '資料',
    },
    deadline: {
      dot: palette.catDeadline,
      chip: palette.catDeadline,
      chipBg: palette.catDeadlineSoft,
      label: '期限',
    },
    contract: {
      dot: palette.catContract,
      chip: palette.catContract,
      chipBg: palette.catContractSoft,
      label: '契約',
    },
