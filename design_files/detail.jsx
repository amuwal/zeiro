        ...
        return (
          <React.Fragment key={i}>
            ...
            {b.c && (
              ...
              >
                {Object.keys(KB).indexOf(b.c) >= 0 ? `[${b.c.split('-')[1]}]` : ''}
              </a>
            )}
          </React.Fragment>
        );
  ...
  if (!inq) {
    return (
      <div className="detail-col">
        <div className="empty">問い合わせを選択してください</div>
      </div>
    );
  }
    ...
    <section className="detail-col" key={inq.id}>
      ...
      <div className="detail-body detail-anim">
        ...
        <div className="section">
          <div className="section-head">
            ...
            <span style={{ flex: 'none' }} className="badge">
              FROM {inq.email}
            </span>
          </div>
          ...
          <div className="ai-banner">
            ...
            <div className="ai-content">
              <div className="ai-row">
                ...
                <span className="val" style={{ color: cat.color }}>
                  ● {cat.jp}
                </span>
                <span className="sep" />
                <span className="label">信頼度</span>
                <div className={`confidence-bar ${confLevel}`}>
                  <i style={{ width: `${inq.confidence * 100}%` }} />
                </div>
                <span className="val" style={{ fontFamily: 'var(--font-mono)', fontSize: 12 }}>
                  {Math.round(inq.confidence * 100)}%
                </span>
                <span className="sep" />
                <span className="label">緊急度</span>
                <span
                  className="val"
                  style={{ color: inq.urgent ? 'var(--urgent)' : 'var(--ink-2)' }}
                >
                  {inq.urgent ? '高' : '通常'}
                </span>
              </div>
            ...
            <div className="draft-card">
              <div className="draft-head">
                ...
                <span className="gen-time">
                  生成 0.42秒前 · {inq.citations.length}件のナレッジを参照
                </span>
        ...
        {inq.citations.length > 0 && (
          <div className="section">
            <div className="section-head">
              ...
              <span className="badge">{inq.citations.length} 件</span>
            </div>
      ...
      <footer className="detail-actions">
        <div className="action-meta">
          ...
          <span className="item">
            <Icon name="clock" size={12} /> 一次対応 <b>2分18秒</b>
          </span>
          <span className="item">
