        ...
        {kpis.map((k) => (
          <div className="kpi" key={k.lbl}>
            ...
            <div className="kpi-foot">
              ...
              <span
                className={`kpi-delta ${k.up ? 'up' : 'down'}`}
                style={{ color: k.good ? 'oklch(45% 0.10 150)' : 'var(--urgent)' }}
              >
                {k.up ? '↗' : '↘'} {k.delta}
              </span>
            </div>
          ...
          <div className="chart-head">
            <div>
              ...
              <div className="chart-sub">
                過去30日 · 計 {cats.reduce((a, c) => a + c.count, 0)}件
              </div>
            </div>
            <div className="kb-sub" style={{ fontFamily: 'var(--font-mono)', fontSize: 11 }}>
              UPDATED 10:42 JST
            </div>
          </div>
